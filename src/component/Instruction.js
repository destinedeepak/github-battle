...
function Instruction() {
    ...
    return (
      <div className={`${darkMode ? 'text-dark bg-dark': ''}`}>
        <h1 className="text-center text-4xl font-light">Instructions</h1>
        <div className="flex justify-between">
          <div>
            <h2 className="text-xl mb-4 mt-8">Enter two Github uers</h2>
            <svg
              stroke="currentColor"
              fill="currentColor"
              strokeWidth="0"
          ...
          <div>
            <h2 className="text-xl mb-4 mt-8">Battle</h2>
            <svg
              stroke="currentColor"
              fill="currentColor"
              strokeWidth="0"
          ...
          <div>
            <h2 className="text-xl mb-4 mt-8">See the user</h2>
            <svg
              stroke="currentColor"
              fill="currentColor"
              strokeWidth="0"
